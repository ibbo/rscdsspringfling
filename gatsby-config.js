  ...
  plugins: [
    ...
    `gatsby-plugin-sharp`,
    {
      ...
      options: {
        ...
        // theme_color: `#663399`,
        display: `minimal-ui`,
        icon: `src/images/rscds_logo.png`, // This path is relative to the root of the site.
      },
    },
    {
      ...
      options: {
        ...
        queryLimit: 1000,
        collectionTypes: [`dance-class`, `dance`],
	      singleTypes: [`homepage`, `accommodation`, `pricing`, `how-to-get-there`, `spring-fringe`, `contact-faq`],
      },
    },
    {
      resolve: `gatsby-source-filesystem`,
